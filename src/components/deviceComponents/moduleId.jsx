...
import { updateSelected } from '../../store/mainSlice';

export default function ModuleId({ index, deviceId, groupId, dinId }) {
  ...
  const onClickHandler = (e) => {
    ...
    dispatch(updateSelected({ deviceId, groupId, dinId, shift }));
